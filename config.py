...
#Bot token @Botfather
TG_BOT_TOKEN = os.environ.get("TG_BOT_TOKEN", "7483356409:AAHSZxlYfd0y6BiBngVqR709vRVeKaSz-E4")
...
SHORTLINK_API = os.environ.get("SHORTLINK_API", "422a662516c12af7a56ed23cd126cf9ef3e7e871")
VERIFY_EXPIRE = int(os.environ.get('VERIFY_EXPIRE', 3600)) # Add time in seconds
IS_VERIFY = os.environ.get("IS_VERIFY", "True")
TUT_VID = os.environ.get("TUT_VID","https://t.me/tutorialtoopenlink/209")
...
try:
    ADMINS=[]
    for x in (os.environ.get("ADMINS", "6095960355").split()):
        ADMINS.append(int(x))
except ValueError:
